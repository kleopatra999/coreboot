...
extern int EmmcWrite (void *Buffer, unsigned int Offset, unsigned int BufferSize);
extern int EmmcRead (void *Buffer, unsigned int Offset, unsigned int BufferSize);
