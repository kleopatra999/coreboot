...
#define grf_readl(offset)	readl((const void *)(GRF_BASE + offset))
#define grf_writel(v, offset)	do { writel(v, (int*)(GRF_BASE + offset)); } while (0)

#define pmu_readl(offset)	readl((const void *)(PMU_BASE_ADDR + offset))
#define pmu_writel(v, offset)	do { writel(v, (int*)(PMU_BASE_ADDR + offset)); } while (0)
