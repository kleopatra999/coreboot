...
static void rk_pwm_iomux_config(int pwm_id)
{
    ...
    case RK_PWM3_IOMUX:
        ...
        break;
    default :
        printk(BIOS_ERR, "RK have not this pwm iomux id!\n");
        break;
    }
}
static void rk_i2c_iomux_config(int i2c_id)
{
    ...
    case RK_I2C4_IOMUX:
        ...
        break;
    case RK_I2C5_IOMUX:
        grf_writel((3<<28)|(1<<12), RK3288_GRF_GPIO7CL_IOMUX);
        grf_writel((3<<16)| 1 , RK3288_GRF_GPIO7CH_IOMUX);
        break;
    default :
        printk(BIOS_ERR, "RK have not this i2c iomux id!\n");
        break;        
    }
}

static void rk_lcdc_iomux_config(void)
{
...
static void rk_spi_iomux_config(int spi_id)
{
    ...
    case RK_SPI1_CS1_IOMUX:
        printk(BIOS_ERR, "rkspi: bus=1 cs=1 not support");
        break;
    ...
    case RK_SPI2_CS1_IOMUX:
        ...
        break;    
    default :
        printk(BIOS_ERR, "RK have not this spi iomux id!\n");
        break;
    }
}
...
static void rk_uart_iomux_config(int uart_id)
{
    ...
    case RK_UART_EXP_IOMUX:
        ...
        break;
    default:
        printk(BIOS_ERR, "RK have not this uart iomux id!\n");
        break;       
    }
...
void rk_iomux_config(int iomux_id)
{
    ...
    case RK_LCDC0_IOMUX:
        ...
        break;
    default :
        printk(BIOS_ERR, "RK have not this iomux id!\n");
        break;
    }     
